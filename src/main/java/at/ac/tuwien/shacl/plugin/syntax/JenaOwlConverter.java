...
public class JenaOwlConverter {
     ...
     *
     * @param jenadata {A resource in the form (S,P,O), it could be any kind of resource (a class, a data property, an
     *        object property and an instance) except a litteral}
    ...
    public synchronized StmtIterator AxiomOwlToJenaResource(Set<OWLAxiom> axioms, String format) {
        ...
        try {
            ...
            OWLOntology ontology =
                manager.createOntology(IRI.create("http://www.semanticweb.org/owlapi/ontologies/ontology"));
    ...
    public synchronized StmtIterator EntityOwlToJenaResource(OWLEntity entity, OWLOntology owlmodel, String format) {
        ...
        try {
            ...
            if (entity.isOWLClass()) {
                ...
                Iterator<OWLAnnotationAssertionAxiom> annotations =
                    entity.getAnnotationAssertionAxioms(owlmodel).iterator();
