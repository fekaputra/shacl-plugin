...
public class InferredOntologyLoader {
    public static OWLOntology loadInferredOntology(Component parent, OWLModelManager modelManager)
        ...
        switch (manager.getReasonerStatus()) {
            case NO_REASONER_FACTORY_CHOSEN:
                JOptionPane.showMessageDialog(owner,
                        ...
                        "Reasoner not initialized", JOptionPane.INFORMATION_MESSAGE);
                break;
            ...
            case OUT_OF_SYNC:
                JOptionPane.showMessageDialog(owner,
                        ...
                        "Reasoner out of sync", JOptionPane.WARNING_MESSAGE);
                break;
            case INITIALIZATION_IN_PROGRESS:
                JOptionPane.showMessageDialog(owner,
                        ...
                        "Reasoner initializing", JOptionPane.WARNING_MESSAGE);
                break;
            case INITIALIZED:
                break; // nothing to do...
        }
